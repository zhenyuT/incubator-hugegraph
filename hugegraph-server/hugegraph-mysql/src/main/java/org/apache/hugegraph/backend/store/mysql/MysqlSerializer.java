...
public class MysqlSerializer extends TableSerializer {
    ...
    protected Id[] toIdArray(Object object) {
        ...
        Number[] values = JsonUtil2.fromJson(value, Number[].class);
    ...
    protected Object toLongList(Collection<Id> ids) {
        ...
        return JsonUtil2.toJson(values);
    }
    ...
    protected void formatProperties(HugeElement element,
        ...
        row.column(HugeKeys.PROPERTIES, JsonUtil2.toJson(properties));
    }
    ...
    protected void parseProperties(HugeElement element,
        ...
        Map<String, Object> props = JsonUtil2.fromJson(properties, Map.class);
        for (Map.Entry<String, Object> prop : props.entrySet()) {
            ...
            String colJson = JsonUtil2.toJson(prop.getValue());
    ...
    protected void readUserdata(SchemaElement schema,
        ...
        @SuppressWarnings("unchecked")
        Map<String, Object> userdata = JsonUtil2.fromJson(json, Map.class);
