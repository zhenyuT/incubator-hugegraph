...
public final class TraversalUtil {
    ...
    private static Number predicateNumber(String value) {
        try {
            return HugeJsonUtil.fromJson(value, Number.class);
        } catch (Exception e) {
            // Try to parse date
            if (e.getMessage().contains("not a valid number") ||
                ...
                try {
                    if (value.startsWith("\"")) {
                        value = HugeJsonUtil.fromJson(value, String.class);
                    }
    ...
    private static <V> V predicateArg(String value) {
        try {
            return (V) HugeJsonUtil.fromJson(value, Object.class);
        } catch (Exception e) {
            throw new HugeException(
    ...
    private static <V> List<V> predicateArgs(String value) {
        try {
            return HugeJsonUtil.fromJson("[" + value + "]", List.class);
        } catch (Exception e) {
            throw new HugeException(
