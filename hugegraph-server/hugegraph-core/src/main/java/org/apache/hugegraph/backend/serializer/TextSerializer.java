...
public class TextSerializer extends AbstractSerializer {
    ...
    private static String writeId(Id id) {
        if (id.number()) {
            return JsonUtil2.toJson(id.asLong());
        } else {
            return JsonUtil2.toJson(id.asString());
        }
    }

    private static Id readId(String id) {
        Object value = JsonUtil2.fromJson(id, Object.class);
    ...
    private static String writeIds(Collection<Id> ids) {
        ...
        return JsonUtil2.toJson(array);
    }

    private static Id[] readIds(String str) {
        Object[] values = JsonUtil2.fromJson(str, Object[].class);
    ...
    private static void writeUserdata(SchemaElement schema,
        ...
        entry.column(HugeKeys.USER_DATA, JsonUtil2.toJson(schema.userdata()));
    }
    ...
    private String formatPropertyValue(HugeProperty<?> prop) {
        ...
        return JsonUtil2.toJson(prop.value());
    }
    ...
    private void parseProperty(String colName, String colValue,
        ...
        // Parse value
        Object value = JsonUtil2.fromJson(colValue, pkey.implementClazz());
        ...
        if (pkey.cardinality() == Cardinality.SINGLE) {
            ...
            for (Object v : (Collection<?>) value) {
                v = JsonUtil2.castNumber(v, pkey.dataType().clazz());
    ...
    private void parseEdge(String colName, String colValue,
        ...
        edge.expiredTime(JsonUtil2.fromJson(valParts[2], Long.class));
    ...
    public BackendEntry writeIndex(HugeIndex index) {
        ...
        if (index.fieldValues() == null && index.elementIds().size() == 0) {
            ...
            entry.column(formatSyspropName(HugeKeys.FIELD_VALUES),
                         JsonUtil2.toJson(index.fieldValues()));
    ...
    public HugeIndex readIndex(HugeGraph graph, ConditionQuery query,
        ...
        index.fieldValues(JsonUtil2.fromJson(indexValues, Object.class));
    ...
    protected Query writeQueryCondition(Query query) {
        ...
        for (Condition.Relation r : result.relations()) {
            ...
            if (r.value() instanceof Id) {
                ...
                r.serialValue(JsonUtil2.toJson(r.value()));
            }
    ...
    public BackendEntry writeVertexLabel(VertexLabel vertexLabel) {
        ...
        entry.column(HugeKeys.NAME, JsonUtil2.toJson(vertexLabel.name()));
        entry.column(HugeKeys.ID_STRATEGY,
                     JsonUtil2.toJson(vertexLabel.idStrategy()));
        ...
        entry.column(HugeKeys.ENABLE_LABEL_INDEX,
                     JsonUtil2.toJson(vertexLabel.enableLabelIndex()));
        writeUserdata(vertexLabel, entry);
        entry.column(HugeKeys.STATUS,
                     JsonUtil2.toJson(vertexLabel.status()));
        return entry;
    }
    ...
    public VertexLabel readVertexLabel(HugeGraph graph,
        ...
        String name = JsonUtil2.fromJson(entry.column(HugeKeys.NAME),
                                         String.class);
        ...
        vertexLabel.idStrategy(JsonUtil2.fromJson(idStrategy,
                                                  IdStrategy.class));
        ...
        vertexLabel.enableLabelIndex(JsonUtil2.fromJson(enableLabelIndex,
                                                        Boolean.class));
        readUserdata(vertexLabel, entry);
        vertexLabel.status(JsonUtil2.fromJson(status, SchemaStatus.class));
        return vertexLabel;
    }
    ...
    public BackendEntry writeEdgeLabel(EdgeLabel edgeLabel) {
        ...
        entry.column(HugeKeys.NAME, JsonUtil2.toJson(edgeLabel.name()));
        ...
        entry.column(HugeKeys.FREQUENCY,
                     JsonUtil2.toJson(edgeLabel.frequency()));
        ...
        entry.column(HugeKeys.ENABLE_LABEL_INDEX,
                     JsonUtil2.toJson(edgeLabel.enableLabelIndex()));
        writeUserdata(edgeLabel, entry);
        entry.column(HugeKeys.STATUS,
                     JsonUtil2.toJson(edgeLabel.status()));
        entry.column(HugeKeys.TTL, JsonUtil2.toJson(edgeLabel.ttl()));
    ...
    public EdgeLabel readEdgeLabel(HugeGraph graph,
        ...
        edgeLabel.frequency(JsonUtil2.fromJson(frequency, Frequency.class));
        ...
        edgeLabel.enableLabelIndex(JsonUtil2.fromJson(enableLabelIndex,
                                                      Boolean.class));
        readUserdata(edgeLabel, entry);
        edgeLabel.status(JsonUtil2.fromJson(status, SchemaStatus.class));
        edgeLabel.ttl(JsonUtil2.fromJson(ttl, Long.class));
    ...
    public BackendEntry writePropertyKey(PropertyKey propertyKey) {
        ...
        entry.column(HugeKeys.NAME, JsonUtil2.toJson(propertyKey.name()));
        entry.column(HugeKeys.DATA_TYPE,
                     JsonUtil2.toJson(propertyKey.dataType()));
        entry.column(HugeKeys.CARDINALITY,
                     JsonUtil2.toJson(propertyKey.cardinality()));
        entry.column(HugeKeys.AGGREGATE_TYPE,
                     JsonUtil2.toJson(propertyKey.aggregateType()));
        entry.column(HugeKeys.WRITE_TYPE,
                     JsonUtil2.toJson(propertyKey.writeType()));
        entry.column(HugeKeys.PROPERTIES, writeIds(propertyKey.properties()));
        writeUserdata(propertyKey, entry);
        entry.column(HugeKeys.STATUS,
                     JsonUtil2.toJson(propertyKey.status()));
        return entry;
    }
    ...
    public PropertyKey readPropertyKey(HugeGraph graph,
        ...
        propertyKey.dataType(JsonUtil2.fromJson(dataType, DataType.class));
        propertyKey.cardinality(JsonUtil2.fromJson(cardinality,
                                                   Cardinality.class));
        propertyKey.aggregateType(JsonUtil2.fromJson(aggregateType,
                                                     AggregateType.class));
        propertyKey.writeType(JsonUtil2.fromJson(writeType,
                                                 WriteType.class));
        propertyKey.properties(readIds(properties));
        readUserdata(propertyKey, entry);
        propertyKey.status(JsonUtil2.fromJson(status, SchemaStatus.class));
        return propertyKey;
    }
    ...
    public IndexLabel readIndexLabel(HugeGraph graph,
        ...
        indexLabel.baseType(JsonUtil2.fromJson(baseType, HugeType.class));
        indexLabel.baseValue(readId(baseValue));
        indexLabel.indexType(JsonUtil2.fromJson(indexType, IndexType.class));
        indexLabel.indexFields(readIds(indexFields));
        readUserdata(indexLabel, entry);
        indexLabel.status(JsonUtil2.fromJson(status, SchemaStatus.class));
        return indexLabel;
    }
