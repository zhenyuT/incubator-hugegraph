...
public class MetricsAPI extends API {
    ...
    static {
        HugeJsonUtil.registerModule(new MetricsModule(SECONDS, MILLISECONDS, false));
    }
    ...
    public String system() {
        return HugeJsonUtil.toJson(this.systemMetrics.metrics());
    }
    ...
    public String backend(@Context GraphManager manager) {
        ...
        return HugeJsonUtil.toJson(results);
    }
    ...
    public String gauges() {
        ...
        return HugeJsonUtil.toJson(reporter.gauges());
    }
    ...
    public String counters() {
        ServerReporter reporter = ServerReporter.instance();
        return HugeJsonUtil.toJson(reporter.counters());
    }
    ...
    public String histograms() {
        ServerReporter reporter = ServerReporter.instance();
        return HugeJsonUtil.toJson(reporter.histograms());
    }
    ...
    public String meters() {
        ServerReporter reporter = ServerReporter.instance();
        return HugeJsonUtil.toJson(reporter.meters());
    }
    ...
    public String timers() {
        ServerReporter reporter = ServerReporter.instance();
        return HugeJsonUtil.toJson(reporter.timers());
    }
    ...
    public String statistics(@QueryParam("type") String type) {
        ...
        if (type != null && type.equals(JSON_STR)) {
            return HugeJsonUtil.toJson(metricMap);
        }
    ...
    public String baseMetricAll() {
        ...
        return HugeJsonUtil.toJson(result);
    }
