...
public interface HugeAuthenticator extends Authenticator {
    ...
    class User extends AuthenticatedUser {
        ...
        public static User fromJson(String json) {
            ...
            UserJson userJson = HugeJsonUtil.fromJson(json, UserJson.class);
            if (userJson != null) {
        ...
        public String toJson() {
            ...
            return HugeJsonUtil.toJson(json);
        }
    ...
    class RolePerm {
        ...
        @Override
        public String toString() {
            return HugeJsonUtil.toJson(this);
        }
    ...
    class RequiredPerm {
        ...
        public static RequiredPerm fromJson(String json) {
            return HugeJsonUtil.fromJson(json, RequiredPerm.class);
        }
