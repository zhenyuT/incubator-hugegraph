...
public abstract class AbstractRestClient2 {
    ...
    public AbstractRestClient2(String url, String user, String password,
                               int timeout) {
    ...
    public AbstractRestClient2(String url, ClientConfig config) {
    ...
    public void put(String path, String id, Object object,
                          Map<String, Object> params) {
        this.put(path, id, object, null, params);
    }
